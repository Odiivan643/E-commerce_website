    ...
    <div class="col-md-8">
        ...
        <label for="more_description" class="form-label">More_description</label>
        <input type="text"  placeholder="More_description ..."  name="more_description" value="{{ old('more_description', isset($product) ? $product->more_description : '') }}" class="form-control" id="more_description" aria-describedby="more_descriptionHelp" required/>
        ...
        <label for="additional_infos" class="form-label">Additional_infos</label>
        <input type="text"  placeholder="Additional_infos ..."  name="additional_infos" value="{{ old('additional_infos', isset($product) ? $product->additional_infos : '') }}" class="form-control" id="additional_infos" aria-describedby="additional_infosHelp" required/>
        ...
        <label for="solde_price" class="form-label">Solde_price</label>
        <input type="text"  placeholder="Solde_price ..."  name="solde_price" value="{{ old('solde_price', isset($product) ? $product->solde_price : '') }}" class="form-control" id="solde_price" aria-describedby="solde_priceHelp" required/>
        ...
        <input type="text"  placeholder="Regular_price ..."  name="regular_price" value="{{ old('regular_price', isset($product) ? $product->regular_price : '') }}" class="form-control" id="regular_price" aria-describedby="regular_priceHelp" required/>
