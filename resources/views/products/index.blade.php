            ...
            <thead>
                <tr>
                    <th scope="col">N#</th>
						...
						<th scope="col">More_description</th>
						<th scope="col">Additional_infos</th>
						<th scope="col">Stock</th>
						<th scope="col">Solde_price</th>
            ...
            <tbody>
                @foreach($products as $product)
						<tr><td>{{ $product->id }}</td>
							...
							<td>{{ $product->more_description }}</td>
							<td>{{ $product->additional_infos }}</td>
							<td>{{ $product->stock }}</td>
							<td>{{ number_format($product->solde_price, 2, ',', ' ') . ' €' }}</td>
